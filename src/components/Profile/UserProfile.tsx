    ...
    <>
      <Row className="justify-content-center">
        <div className='d-flex flex-wrap gap-3 mt-3 p-0 m-0 ps-3 ms-3'>
          <p
            className={`text-sm fs_28 red_ff text-color fw-semibold C-pointer m-0 p-0 ${activeComponent === 'Profile' ? 'text-primary' : ''}`}
            onClick={handleComponentChange('Profile')}
          >
            Profile
          </p>
          <p
            className={`text-sm fs_28 red_ff text-color fw-light C-pointer m-0 p-0 ${activeComponent === 'Cards' ? 'text-primary' : ''}`}
            onClick={handleComponentChange('Cards')}
          >
            Cards
          </p>
          <p
            className={`text-sm fs_28 red_ff text-color fw-light C-pointer m-0 p-0 ${activeComponent === 'SocialMedia' ? 'text-primary' : ''}`}
            onClick={handleComponentChange('SocialMedia')}
          >
            Social Media
          </p>
          <p
            className={`text-sm fs_28 red_ff text-color fw-light C-pointer m-0 p-0 ${activeComponent === 'CarRegistration' ? 'text-primary' : ''}`}
          ...
          {activeComponent === 'Profile' && (
            <Row className="justify-content-center">
              <Col xs={12} md={6} className='d-flex justify-content-around flex-wrap'>
                <div className="me-5 margin-right-0 pe-5">
                  ...
                  <Form className="mt-5 ps-4 margin-right-0  " onSubmit={handleSubmit}>
                    <div className='d-flex sm-d-flex flex-column flex-md-row gap-3   md:w-100 ps-3 my-3 '>
                    ...
                    <div className='d-flex sm-d-flex flex-column flex-md-row gap-3 w-100 my-3 ps-3'>
                    ...
                    <div className='d-flex sm-d-flex flex-column flex-md-row gap-3 w-100 my-3 ps-3'>
                      ...
                      <Form.Group className="mb-3 w-100 fs-16 red_ff fw-light" controlId="corporateCard">
                        ...
                        <Form.Control type="text" placeholder="046831166" />
                      </Form.Group>
                    </div>
              ...
              <Col xs={12} md={6} className='mt-4 mt-md-0 '>
                ...
                <div className='d-flex gap-5 custom-flex'>
                  ...
                  <button className='border-0 sm-fs_14 mb-3 fw-medium px-2 py-1 rounded-2 postpaid-button' onClick={handleShowPostpaidModal}>
