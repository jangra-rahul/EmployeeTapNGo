    ...
    <div className="min-vh-100 py-3 d-flex flex-column align-items-center justify-content-center bg_theme">
      <Container>
        ...
        <div className="d-flex justify-content-center">
          ...
          >
            <h5 className=" red_ff fs_24 fw-semibold">Enter Card Number</h5>
            <Form.Group controlId="formMobileNumber" className="mb-3 mt-4">
            ...
            <Link href="/Dashboard/Modals/AccountSetup">
              <button
