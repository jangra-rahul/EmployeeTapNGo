...
const PostpaidSuccessfulModal: React.FC = () => {
      ...
      <Container>
        ...
        <div className="d-flex justify-content-center">
          ...
          >
            ...
            <p className=" color_blue my-2 text-center">
              Reference No. 123456879
            </p>
            <p className="text-center red_ff" style={{ color: "#666666" }}>
              Your application will be reviewed and they will hear back from us
              shortly.
            </p>
          </div>
        </div>
...
export default PostpaidSuccessfulModal;
