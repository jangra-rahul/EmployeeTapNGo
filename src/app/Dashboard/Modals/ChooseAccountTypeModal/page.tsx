...
const ChooseAccountTypeModal: React.FC = () => {
  ...
  const getRoute = () => {
    switch (selectedAccountType) {
      case "prepaid":
        return "/Dashboard/Modals/SuccessfulModal";
      case "postpaid":
        return "/Dashboard/Modals/AddPaymentMethodModal";
      case "Subscriptions":
        return "/Dashboard/Modals/SubscriptionMethodModal"; // Example for subscriptions
      default:
        return "#"; // fallback
    }
  };
      ...
      <Container>
        ...
        <div className="d-flex justify-content-center">
          ...
          >
            ...
            {/* Subscriptions Account Type */}
            <label
              className={`border-2 rounded-2 mt-4 w-100 p-3 cursor-pointer ${
                selectedAccountType === "Subscriptions"
                  ? "border-primary border"
                  : "border"
              }`}
              onClick={() => handleSelectAccountType("Subscriptions")}
            >
              <div className="d-flex justify-content-between align-items-center">
                <h5 className="mb-0 fs_16 fw-semibold">Subscriptions</h5>
                <input
                  type="radio"
                  checked={selectedAccountType === "Subscriptions"}
                  readOnly
                  className="form-check-input"
                />
              </div>
