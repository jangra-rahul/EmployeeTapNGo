...
const AddBanckAccountModal: React.FC = () => {
          ...
          >
            ...
            <div className="d-flex align-items-center mt-4 justify-content-between">
              <div className="d-flex gap-3 px-2  align-items-center">
                ...
                <p className="mb-0 fw-bold red_ff">Card Payment</p>
              </div>
              <Link href="/Dashboard/Modals/AddBanckAccountDetailsModal">
                <p className=" fs_14 fw-medium red_ff mb-0 tdn color_blue">
                  Add Bank Account
                </p>
              </Link>
            </div>
...
export default AddBanckAccountModal;
