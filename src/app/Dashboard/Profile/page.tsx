  ...
  return (
    ...
    <Layout>
      ...
      <Row className="justify-content-center text-nowrap bg-white mt-4 rounded-3 ">
        <div className='d-flex flex-wrap gap-md-5 gap-sm-2 mt-3 p-0 m-0 ps-5 text-nowrap'>
          <p
            className={`text-sm fs_24 red_ff text-color fw-light C-pointer m-0 p-0 ${activeComponent === 'Profile' ? 'active text-primary' : ''}`}
            onClick={handleComponentChange('Profile')}>
            Profile
          </p>
          <p
            className={`text-sm fs_24 red_ff text-color fw-light C-pointer m-0 p-0 ${activeComponent === 'Cards' ? 'active text-primary' : ''}`}
            onClick={handleComponentChange('Cards')}>
            Cards
          </p>
          <p
            className={`text-sm fs_24 red_ff text-color fw-light C-pointer m-0 p-0 ${activeComponent === 'SocialMedia' ? 'active text-primary' : ''}`}
            onClick={handleComponentChange('SocialMedia')}>
            Social Media
          </p>
          <p
            className={`text-sm fs_24 red_ff text-color fw-light C-pointer m-0 p-0 ${activeComponent === 'CarRegistration' ? 'active text-primary' : ''}`}
            onClick={handleComponentChange('CarRegistration')}>
            Car Registration
          </p>
        </div>
        <hr className='text-dark line-margin' />
      <Row className="">
        <Col xs={12}>
          {activeComponent === 'Profile' && (
            <Row className="justify-content-center bg-white ps-3">
              <Col xs={12} md={6} className='d-flex justify-content-start flex-wrap'>
                <div className="pe-5">
                  ...
                  <Form className="mt-5 text-dark" onSubmit={handleSubmit}>
                    <div className='d-flex flex-column responsive-display flex-md-row gap-3 ps-3 my-3'>
                    ...
                    <div className='d-flex flex-column responsive-display flex-md-row gap-3 w-100 my-3 ps-3'>
                    ...
                    <div className='d-flex flex-column responsive-display flex-md-row gap-3 w-100 my-3 ps-3'>
                      ...
                      <Form.Group className="mb-3 w-100 fs_16 red_ff fw-light" controlId="corporateCard">
                        <Form.Label>Corporate Card</Form.Label>
                        <Form.Control type="text" placeholder="04683116661" />
                      </Form.Group>
                    </div>
                    <Form.Group className="mb-3 responsive-display ps-3 w-100 fs_16 red_ff fw-light" controlId="accountType">
              ...
              <Col xs={12} md={6} className='mt-4 mt-md-0  text-dark'>
                ...
                <div className='d-flex gap-5 custom-flex flex-wrap'>
                  ...
                  <button className='border-0 sm-fs_14 mb-3 fw-medium px-3 py-1 rounded-2 postpaid-button' onClick={handleShowPostpaidModal}>
